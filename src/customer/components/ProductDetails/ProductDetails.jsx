...
import { Rating,Button, LinearProgress,Box} from '@mui/material'
...
export default function ProductDetails() {
 ...
 <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
          <div className="lg:col-span-2 ">
            <h1 className="text-gl lg:text-xl font-semobold text-gray-900">Universaloutfit</h1>
            <h1 className='text-lg lg:test-xl text-gray-900 opacity-60 pt-1'>Casual Puff Sleeves Solid Women White Top</h1>
          </div>
    ...
    {/*ratings and reviews*/}
    <section>
        <h1 className='font-semibold ext-lg pb-4'>Recent Reviews & Ratings</h1>
            ...
            <Grid item xs={5}>
                ...
                <Box className="mt-5 space-y-3">
                    ...
                    <Grid container  alignItems="center" gap={2} >
                        ...
                        <Grid item xs={7}>
                            <LinearProgress sx={{bgcolor:"#d0d0d0",borderRadius:4,height:7}}variant="determinate" value={30} className='bg-yellow-300'/>
                        </Grid>
